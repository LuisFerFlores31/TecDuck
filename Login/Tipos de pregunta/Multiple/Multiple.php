...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tipo = 2; // Tipo para múltiple opción
    ...
    if ($respuestas_validas < 2) {
        die("Error: Debe proporcionar al menos 2 opciones de respuesta");
    }
    ...
    try {
        ...
        header("Location: Multiple.html?success=1&user=" . urlencode($_SESSION["email"]));
        exit();
